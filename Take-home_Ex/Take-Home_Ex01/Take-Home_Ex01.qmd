...
The advantages of using a Kernel Density Map over a point map is that visualisation is made easier using a Kernel Density Map because it does not explicitly show every single point (we can quickly zoom into the areas that have clusters)
